...
namespace SichuanOpera
{
	public class FileBrowser{
		...
		public Color selectedColor = new Color(0f,0.5f,0.9f); //the color of the selected file
		...
		protected bool getFiles = true,showDrives=true;
		...
		public bool draw(){
			...
			case 0:
				...
				GUILayout.BeginHorizontal("box");
				GUILayout.BeginVertical(GUILayout.MaxWidth(160));
				...
				GUILayout.FlexibleSpace();
				if((selectStyle == null)?GUILayout.Button("选择"):GUILayout.Button("选择",selectStyle)){	return true;	}
				GUILayout.FlexibleSpace();
				GUILayout.EndHorizontal();
				GUILayout.EndVertical();
				GUILayout.EndHorizontal();
